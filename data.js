...
// 1. Data for the "Your Stock Portfolio" cards (Added quantity)
const portfolioStocks = [
    { id: 1, name: "Apple, Inc", ticker: "AAPL", logoUrl: "placeholder-logo-apple.png", portfolioValue: 15215.70, dayChangePercent: 0.66, quantity: 80, miniChartData: [50, 52, 51, 53, 54, 53, 55] },
    { id: 2, name: "Google LLC", ticker: "GOOGL", logoUrl: "placeholder-logo-google.png", portfolioValue: 10570.45, dayChangePercent: -0.25, quantity: 10, miniChartData: [100, 98, 99, 97, 96, 98, 97] },
    { id: 3, name: "Tesla, Inc.", ticker: "TSLA", logoUrl: "placeholder-logo-tesla.png", portfolioValue: 8750.00, dayChangePercent: 1.85, quantity: 40, miniChartData: [200, 205, 210, 208, 212, 215, 214] },
    { id: 4, name: "Microsoft", ticker: "MSFT", logoUrl: "placeholder-logo-msft.png", portfolioValue: 12345.67, dayChangePercent: 0.95, quantity: 30, miniChartData: [300, 302, 301, 305, 304, 306, 307] },
    { id: 5, name: "Amazon", ticker: "AMZN", logoUrl: "placeholder-logo-amzn.png", portfolioValue: 9876.54, dayChangePercent: -0.10, quantity: 50, miniChartData: [150, 151, 149, 148, 150, 152, 151] },
    { id: 6, name: "NVIDIA", ticker: "NVDA", logoUrl: "placeholder-logo-nvda.png", portfolioValue: 11111.11, dayChangePercent: 2.50, quantity: 25, miniChartData: [400, 410, 405, 415, 420, 418, 425] },
    { id: 7, name: "Meta", ticker: "META", logoUrl: "placeholder-logo-meta.png", portfolioValue: 7654.32, dayChangePercent: -0.80, quantity: 35, miniChartData: [250, 248, 245, 246, 247, 244, 242] },
    { id: 8, name: "Netflix", ticker: "NFLX", logoUrl: "placeholder-logo-nflx.png", portfolioValue: 6543.21, dayChangePercent: 1.15, quantity: 15, miniChartData: [500, 505, 510, 508, 512, 515, 514] }
];
